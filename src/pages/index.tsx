import {
  Users, Calendar, MapPin, Zap, Star, Code, Shield, Cpu, Database, BookOpen, Globe, GitBranch, Rocket,
  DollarSign,
  Handshake,
  Lock,
  Network,
  ...
  const milestones = [
    {
      ...
      description: "由 Keone Hon、James Hunsaker 和 Eunice Giarta 联合创办，开启高性能 EVM 链研究。",
      src: "",
    ...
    },
    {
      date: "2025年5月5日",
      title: "启动测试网‑2 验证者阶段",
      description: "Monad 推出验证者专属 Testnet‑2，将于年底前为主网上线做准备。",
        ...
        <div className={styles.container}>
          <div className={`${styles.heroContent} ${isVisible ? styles.heroVisible : ""}`}>
            ...
            <p className={styles.heroSubtitle}>
              <span className={styles.heroHighlight}>加入我们，和 Nads 一起了解、参与、构建 Monad</span>
            </p>
        ...
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            ...
            <div className={styles.ctaButtons}>
              <Link href="https://discord.gg/monad" target="_blank" className={styles.ctaPrimaryButton}>
                <SiDiscord className={styles.buttonIcon} />
                加入 Discord
              </Link>
              <Link href="https://www.monad.xyz/" target="_blank" className={styles.ctaSecondaryButton}>
                <Globe className={styles.buttonIcon} />
                访问官方网站
              </Link>
            </div>
