        ...
        <div className={styles.statusSection}>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} sm={12} md={6}>
              <Card
                className={`${styles.statusCard} ${styles.statusCardGreen}`}
              >
            ...
            <Col xs={24} sm={12} md={6}>
              <Card
                className={`${styles.statusCard} ${styles.statusCardPurple}`}
              >
                ...
                <div className={styles.statusCardContent}>
                  ...
                  <DynamicStatistic
                    title={
                      <span style={{ display: 'flex', marginLeft: 40, gap: 2 }}>
                        验证者节点
                        <Tag
                          className={styles.validatorTag}
                    ...
                    value={stat?.validators as number}
                    color="#6366F1"
                    showDecimals={false}
                    showSuffix={false}
                  />
            ...
            <Col xs={24} sm={12} md={6}>
              <Card className={`${styles.statusCard} ${styles.statusCardBlue}`}>
                ...
                <div className={styles.statusCardContent}>
                  ...
                  <DynamicStatistic
                    title="区块高度"
                    value={stat?.block_num.toLocaleString() as string}
                    color="#3b82f6"
                    showDecimals={false}
                    showSuffix={false}
                  />
            ...
            <Col xs={24} sm={12} md={6}>
              <Card
                className={`${styles.statusCard} ${styles.statusCardOrange}`}
              >
                <Link href="https://testnet.monadexplorer.com/" target="_blank">
                  <ExternalLink size={16} className={styles.externalIcon} />
                </Link>
                <div className={styles.statusCardContent}>
                  ...
                  <DynamicStatistic
                    title="出块时间"
                    value={stat?.avg_block_time as string}
                    color="#f59e0b"
                  />
                </div>
              </Card>
              ...
              >
                <div className={styles.infoItem}>
                  <div className={styles.infoItemHeader}>
                    <Calendar size={24} />
                    <Text strong className={styles.phaseText}>
                      Testnet-1：
                      <span className={styles.phaseTime}>2025年2月19日</span>
                    </Text>
                  </div>
                  <div className={styles.launchInfo}>
                    <Text type="secondary">
                      1、首次上线于 2025 年 2 月 19
                      日，提供安全的无风险环境供开发者调试和用户体验社区
                      dApp（如 Uniswap、Fantasy Top、Dialect’s Blinks 等）。
                      <br />
                      2、官方建议用户尝试众多生态应用，并通过钱包（Phantom、OKX、Backpack
                      等）连接网络、获取测试代币并参与交互。
                    </Text>
                  </div>
                </div>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div className={styles.launchInfo}>
                    <Text type="secondary">
                      1、于2025年5月底启动，历时约10周，面向验证者选拔阶段。
                      <br />
                      2、目标数量：100–150
                      名验证者，旨在提升整体网络抗压与节点多样性。
                      <br />
                      3、官方强调：此阶段仅限验证者参与，普通用户的体验不受影响。
                    </Text>
                  </div>
                </div>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div className={styles.launchInfo}>
                    <Text type="secondary">
                      1、Testnet-1 与 Testnet-2
                      同时运行，保证普通用户与验证者能够各自独立进行测试，不互相干扰。
                      <br />
                      2、验证者节点优先考虑地理多样性，提升全球网络节点的分布广度。
                      <br />
                      3、Testnet-2
                      本质是“预主网演练”，强调验证者硬件配备与运维能力，并借此为主网做准备。
                    </Text>
                  </div>
                </div>
              </Space>
                ...
                <div className={styles.configItem}>
                  ...
                  <div className={styles.configRow}>
                    ...
                    <Button
                      ...
                      icon={<Copy size={14} />}
                      onClick={() =>
                        copyToClipboard('Monad Testnet', '网络名称')
                      }
        ...
        <Card className={styles.faucetCard} id="faucetSection">
          ...
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card
                size="small"
                className={`${styles.faucetItem} ${styles.faucetItemRecommended}`}
              >
                <div className={styles.faucetContent}>
                  <div className={styles.faucetHeader}>
                    <Text strong className={styles.faucetText}>
                      官方水龙头
                    </Text>
                    <Tag className={styles.recommendedTag}>推荐</Tag>
                  </div>
                  <Text type="secondary" className={styles.faucetDescription}>
                    钱包需在 Ethereum 主网持有 ≥0.03 ETH，且完成 ≥3
                    笔主网交易；钱包内 MON 数量少于 5。符合条件可每 6 小时领取 2
                    MON。
                  </Text>
                  <Button
                    type="primary"
            ...
            <Col xs={24} md={8}>
              <Card size="small" className={styles.faucetItem}>
                <div className={styles.faucetContent}>
                  ...
                  <Text type="secondary" className={styles.faucetDescription}>
                    登录后绑定 GitHub 账号，根据 GitHub 账号等级每日可领 0.1-1
                    MON。
                    <br />
                    <div style={{ display: 'flex', gap: '16px', marginTop: 4 }}>
                      <span>
                        <strong>S</strong>: 1 MON
                      </span>
                      <span>
                        <strong>A</strong>: 0.4 MON
                      </span>
                      <span>
                        <strong>B</strong>: 0.3 MON
                      </span>
                      <span>
                        <strong>C</strong>: 0.1 MON
                      </span>
                    </div>
                  </Text>
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://faucet.openbuild.xyz/monad',
                        '_blank'
                      )
                    }
                    className={styles.faucetButtonSecondary}
                ...
                <div className={styles.cardFooter}>
                  <div className={styles.tutorialsInfo}>
                    ...
                    <span className={styles.tutorialCount}>
                      {dapp.tutorials?.length || 0} 个教程
                    </span>
                  </div>
                  <Link
                    href={`/ecosystem/dapps/${dapp.ID}`}
